...
def uti_plot2d(ar2d, x_range, y_range, colormap, labels=('Horizontal Position [m]','Vertical Position [m]'), units=None): #AH29082019
    ...
    _backend.uti_plot2d(ar2d, x_range, y_range, colormap, labels)#AH29082019
...
def uti_plot2d1d(ar2d, x_range, y_range, x=0, y=0, labels=('Horizontal Position', 'Vertical Position', 'Intensity'), units=None, colormap=None, graphs_joined=True):#AH29082019
    ...
    _backend.uti_plot2d1d(ar2d, x_range, y_range, x, y, labels, colormap, graphs_joined)#AH29082019
...
def uti_plot_data_file(_fname, _read_labels=1, _e=0, _x=0, _y=0, _graphs_joined=True, #Same as uti_data_file_plot, but better fits function name decoration rules in this module (uti_plot*)
                       ...
                       _scale='linear', _width_pixels=None, _rotation_angle=0, _colormap='Greys_r'): #AH29082019
    ...
    :param float _rotation_angle: the rotation angle of the image, positive value rotate the image clockwise, negative value-countclockwise
    :param str _colormap: the colormap to use in plots, (Greys_r by default, but could use any other colormaps: afmhot, coolwarm, jet, PiYG......)
    """
    #if '_backend' not in locals(): uti_plot_init() #?
    _backend.uti_plot_data_file(_fname, _read_labels, _e, _x, _y, _graphs_joined,
                                _multicolumn_data, _column_x, _column_y, #MR31102017
                                _scale, _width_pixels, _rotation_angle, _colormap) #AH29082019

...
if __name__=='__main__':
    ...
    p.add_option('-r', '--rotation-angle', dest='rotation_angle', metavar='NUMBER', type='float', default=0, help='the angle to rotate image, positive value rotate the image clockwise, negative value-countclockwise') #AH28082019
    p.add_option('-c', '--colormap', dest='colormap', metavar='COLORMAP', default='Greys_r', help='colormap to use in plots(Greys_r, afmhot, coolwarm, jet, PiYG....)') #AH28082019
    ...
    uti_plot_data_file(opt.infile, opt.readlab, opt.e, opt.x, opt.y, opt.joined,
                       ...
                       opt.scale, opt.width_pixels, opt.rotation_angle, opt.colormap) #AH28082019
